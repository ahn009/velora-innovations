...
const tiers = [
  { name: 'Foundation', eyebrow: 'One focused workflow', price: 'From $2,500', note: 'USD · one-time implementation', description: 'For a business starting with one clearly bounded customer or internal process.', icon: Layers3, featured: false, features: ['One communication channel', 'One core use case', 'Knowledge and workflow setup', 'Basic integration', 'Testing and human handoff rules', 'Launch monitoring'] },
