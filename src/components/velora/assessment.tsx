...
const steps = [
  { id: 'business', label: 'Business' }, { id: 'inquiries', label: 'Inquiries' }, { id: 'operations', label: 'Operations' },
  { id: 'technology', label: 'Technology' }, { id: 'goals', label: 'Goals' }, { id: 'readiness', label: 'Readiness' }, { id: 'contact', label: 'Contact' },
] as const

const options = {
  industry: [['home-services', 'Home services'], ['dental', 'Dental practice'], ['medical', 'Medical practice'], ['law', 'Law firm'], ['real-estate', 'Real estate'], ['property-management', 'Property management'], ['accounting', 'Accounting'], ['automotive', 'Automotive'], ['e-commerce', 'E-commerce'], ['other', 'Other']],
