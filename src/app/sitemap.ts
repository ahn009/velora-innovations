...
const routes = [
  ...
  '/assessment', '/consultation', '/how-it-works', '/pricing', '/about', '/contact', '/resources', '/resources/demo', '/resources/faq', '/resources/integrations', '/resources/security', '/resources/workflows', '/resources/calculator',
]
