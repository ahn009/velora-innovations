...
export const metadata = pageMetadata({ title: 'AI CRM Automation | Velora Innovations', description: 'Keep approved lead details, statuses, notes, owners, tasks, and appointment outcomes current in your CRM.', path: '/solutions/crm-automation' })
