...
export const metadata = pageMetadata({ title: 'AI Follow-Up Automation | Velora Automations', description: 'Keep missed calls, unbooked leads, quotes, reminders, and post-consultation actions moving with approved follow-up rules.', path: '/solutions/follow-up-automation' })
