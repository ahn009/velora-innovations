...
export const metadata = pageMetadata({ title: 'AI Appointment Automation | Velora Automations', description: 'Coordinate qualification, availability, booking, reminders, and human exceptions around the scheduling system your business uses.', path: '/solutions/appointment-automation' })
