...
export const metadata = pageMetadata({ title: 'AI Automation for Real Estate | Velora Automations', description: 'Qualify buyer and seller inquiries, coordinate viewings, route property questions, and keep agent follow-up visible.', path: '/industries/real-estate' })
