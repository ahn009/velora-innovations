...
export const metadata = pageMetadata({ title: 'AI Automation for Law Firms | Velora Automations', description: 'Support non-advisory new-client intake, consultation scheduling, matter-type routing, and follow-up for law firms.', path: '/industries/law-firms' })
