...
import { lawFirms, IndustryPageTemplate } from '@/components/velora/page-templates'
...
export default function Page() { return <IndustryPageTemplate content={lawFirms} current="Law Firms" consultationPath="/consultation?industry=law-firms" /> }
