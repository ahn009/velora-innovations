...
import { automotive, IndustryPageTemplate } from '@/components/velora/page-templates'
...
export default function Page() { return <IndustryPageTemplate content={automotive} current="Automotive" consultationPath="/consultation?industry=automotive" /> }
