...
export const metadata = pageMetadata({ title: 'AI Automation for Automotive Businesses | Velora Automations', description: 'Capture vehicle and service details, coordinate appointments, and keep estimate follow-up visible for automotive teams.', path: '/industries/automotive' })
