...
export const metadata = pageMetadata({ title: 'Unsubscribe | Velora Automations', description: 'Manage email preferences for Velora Automations updates.', path: '/unsubscribe', index: false })
